...
use GibbonCms\Gibbon\PersistableEntityRepository;
use GibbonCms\Gibbon\Tests\Stubs\Entity;
use GibbonCms\Gibbon\Tests\Stubs\EntityFactory;

class PersistableEntityRepositoryTest extends TestCase
{
    function setUp()
    {
        $this->repository = new PersistableEntityRepository(
    ...
    {
        $this->assertInstanceOf(PersistableEntityRepository::class, $this->repository);
    }
